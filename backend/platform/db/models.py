...
class SecurityIncident(Base):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "claimed_org_name": self.organization.name if self.organization else (self.call_session.claimed_org_name if self.call_session else None),
            "target_individual": self.target_individual or "Sreya Sengupta",
            "credential_exposure": ("credential" in (self.reasons_json or "").lower() or "otp" in (self.reasons_json or "").lower()),
