...
const IDENTITY_CONFIG = {
  verified: { icon: CheckCircle, text: 'Caller identity verified', color: 'text-blue-700' },
  degraded: { icon: HelpCircle, text: 'Verification Degraded — Call conditions affecting check', color: 'text-amber-700' },
  unverified: { icon: HelpCircle, text: 'Identity not confirmed', color: 'text-slate-600' },
  failed: { icon: XCircle, text: 'Caller identity could not be verified', color: 'text-red-700' },
  unavailable: { icon: HelpCircle, text: 'Verification unavailable', color: 'text-slate-500' },
  checking: { icon: Loader2, text: 'Verifying caller identity…', color: 'text-blue-700' },
};
