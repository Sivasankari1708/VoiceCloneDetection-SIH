...
// ─── Severity ───────────────────────────────────────────────
export type SeverityLevel = 'SAFE' | 'LOW' | 'CAUTION' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
...
// ─── Intervention Stages (Critical Request Protective Response) ──
...
export interface SecurityStatus {
  ...
  // Batch 2B Verification Event context
